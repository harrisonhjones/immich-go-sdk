...
// checks if the SyncAssetV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyncAssetV2{}

// SyncAssetV2 struct for SyncAssetV2
...
func (o SyncAssetV2) MarshalJSON() ([]byte, error) {
...
func (o SyncAssetV2) ToMap() (map[string]interface{}, error) {
...
func (o *SyncAssetV2) UnmarshalJSON(data []byte) (err error) {
	...
	varSyncAssetV2 := _SyncAssetV2{}

	err = json.Unmarshal(data, &varSyncAssetV2)

	if err != nil {
		return err
	}

	*o = SyncAssetV2(varSyncAssetV2)
...
type NullableSyncAssetV2 struct {
	value *SyncAssetV2
	isSet bool
}

func (v NullableSyncAssetV2) Get() *SyncAssetV2 {
	return v.value
}

func (v *NullableSyncAssetV2) Set(val *SyncAssetV2) {
	v.value = val
	v.isSet = true
}

func (v NullableSyncAssetV2) IsSet() bool {
	return v.isSet
}

func (v *NullableSyncAssetV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyncAssetV2(val *SyncAssetV2) *NullableSyncAssetV2 {
	return &NullableSyncAssetV2{value: val, isSet: true}
}

func (v NullableSyncAssetV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyncAssetV2) UnmarshalJSON(src []byte) error {
	v.isSet = true

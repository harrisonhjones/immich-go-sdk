...
func Test_immich_WorkflowsAPIService(t *testing.T) {
	...
	t.Run("Test WorkflowsAPIService GetWorkflowForShare", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id string

		resp, httpRes, err := apiClient.WorkflowsAPI.GetWorkflowForShare(context.Background(), id).Execute()
	...
	t.Run("Test WorkflowsAPIService GetWorkflowTriggers", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.WorkflowsAPI.GetWorkflowTriggers(context.Background()).Execute()
